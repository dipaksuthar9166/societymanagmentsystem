...
import { Mail, Loader2, ArrowRight, Globe, ArrowLeft } from 'lucide-react';
...
const ForgotPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                showSuccess('Email Sent', 'Please check your email for the reset link.');
                // Optionally navigate to login or stay here
            } else {
                        ...
                        <div className="relative px-8 py-8 border-b border-indigo-500/10">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-indigo-300/60 text-xs font-bold uppercase tracking-widest mt-0.5">Account Recovery</p>
                                </div>
                            </div>
                        </div>
